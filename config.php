...
$site_name = 'Starcraft 2 AI Ladder';
...
$from_email = 'noreply@sc2ai.net'; //Webmaster email
$from_name = 'SC2AI.net'; //"From name" displayed on email
...
$password_recover = 'A request has been received to reset the password for your account.  Click this link to reset your password: '; // Password recovery
$password_conf = 'Your request has been processed. You should recieve an email shortly'; 
