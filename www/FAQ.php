...
<br>
If you are just starting <a href="http://wiki.sc2ai.net/CommandCenter_Getting_started_for_the_Ladder_Manager">here</a> you can find a guide explaining how to start with a generic bot you can use as starting point (recommanded). If you instead want to start with a blank bot use <a href="http://wiki.sc2ai.net/Getting_started_for_the_Ladder_Manager_from_scratch">this guide.</a>
